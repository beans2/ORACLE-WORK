...
values(order_code,1,'김정윤','010-3456-4756','211.63.18.133','L_000001');
insert into ordering(ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code,3,'공선의','010-5436-2455','211.63.18.157','L_000001');
insert into ordering(ORDER_NUM,  QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code,1,'이재현','010-2314-8781','211.63.18.135','L_000002');
commit;
